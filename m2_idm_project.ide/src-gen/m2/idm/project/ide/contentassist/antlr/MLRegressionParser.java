...
public class MLRegressionParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, MLRegressionGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getPredictiveVarsAccess().getGroup_3(), "rule__PredictiveVars__Group_3__0");
			builder.put(grammarAccess.getTargetVarsAccess().getGroup(), "rule__TargetVars__Group__0");
			builder.put(grammarAccess.getTargetVarsAccess().getGroup_3(), "rule__TargetVars__Group_3__0");
			...
			builder.put(grammarAccess.getMLRegressionAccess().getLoopAssignment_5(), "rule__MLRegression__LoopAssignment_5");
			...
			builder.put(grammarAccess.getPredictiveVarsAccess().getPredVarAssignment_2(), "rule__PredictiveVars__PredVarAssignment_2");
			builder.put(grammarAccess.getPredictiveVarsAccess().getPredVarAssignment_3_1(), "rule__PredictiveVars__PredVarAssignment_3_1");
			builder.put(grammarAccess.getTargetVarsAccess().getTargetVarAssignment_2(), "rule__TargetVars__TargetVarAssignment_2");
			builder.put(grammarAccess.getTargetVarsAccess().getTargetVarAssignment_3_1(), "rule__TargetVars__TargetVarAssignment_3_1");
			...
			builder.put(grammarAccess.getLoopAccess().getIAssignment_2(), "rule__Loop__IAssignment_2");
